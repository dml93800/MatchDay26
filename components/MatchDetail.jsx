    ...
    <div style={{ position:'fixed', inset:0, background:'var(--bg)', zIndex:200, overflowY:'auto', maxWidth:480, margin:'0 auto' }}>
      ...
      <div style={{ padding:16 }}>
        {allGoals.length > 0 ? (
          ...
          <div style={{ textAlign:'center', color:'var(--text3)', padding:'1rem 0', fontSize:13 }}>
            Aucun but inscrit dans ce match
          </div>
        )}

        <div style={{ background:'var(--bg2)', border:'1px solid var(--border)', borderRadius:10, padding:'14px', fontSize:12, color:'var(--text3)', textAlign:'center', marginTop:8 }}>
