...
export default function MatchCard({ match, prono, onSaveProno, isHero = false, onSelect }) {
  ...
  useEffect(() => {
    const query = match.ground ? `football stadium ${match.ground}` : 'football stadium night'
          ...
          <div className="hero-content">
            ...
            <div className="hero-teams">
              ...
              <div className="hero-score-block">
                {isUpcoming ? <div className="hero-score-vs">vs</div> : <div className="hero-score">{hs} - {as_}</div>}
                <div className="hero-score-status">{isUpcoming ? formatMatchTime(match.time) : 'Terminé'}</div>
              </div>
              <div className="hero-team">
    ...
    >
      ...
      <div className="match-item-info">
        ...
        <div className="match-item-meta">
          ...
          {isUpcoming && ` · ${formatMatchTime(match.time)}`}
        </div>
      </div>
